...
export default function Login() {
  ...
  const [error, setError] = useState(
    searchParams.has("error")
      ? "There was a problem with your previous request. Please Login"
      : null
  );
  ...
  return (
    ...
    >
      ...
      >
        <Button variant="contained" sx={{ mt: 1, ml: 1 }} onClick={handleLogin}>
          Login
        </Button>
        <Button variant="contained" sx={{ mt: 1, ml: 1 }} to="/ForgotUsername">
          Forgot Username
        </Button>
        <Button variant="contained" sx={{ mt: 1, ml: 1 }} to="/ForgotPassword">
          Forgot Password
        </Button>
      </Box>
