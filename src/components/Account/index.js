            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  checked={emailIR}
                  onChange={(event) =>
                    handleChange("Email_IR", event.target.checked)
                  }
                />
              }
              label="Email me when my players go on IR"
            />
          </FormGroup>
          <FormGroup>
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  checked={emailStats}
                  onChange={(event) =>
                    handleChange("Email_Stats", event.target.checked)
                  }
                />
              }
              label="Email me when weekly stats are run"
            />
          </FormGroup>
        </Box>
      ) : null}
