    ...
    <Root title={"General Settings"}>
      ...
      >
        ...
        <FormControl fullWidth>
          <InputLabel id="lineup-deadlines-select-label">
            Lineup DeadLines
          </InputLabel>
          <Select
            ...
            onChange={(event) =>
              handleChange("LineupDeadline", event.target.value)
            }
          >
          ...
          <FormControlLabel
            control={
              <Checkbox
                name="useWaivers"
                onChange={(event) =>
                  handleChange("Waivers", event.target.checked)
                }
                checked={waivers}
              />
            }
        ...
        >
          <FormControl fullWidth>
            ...
            <Select
              ...
              label="Waiver Start"
              onChange={(event) =>
                handleChange("WaiversFromWeek", event.target.value)
              }
            >
              {[...Array(19).keys()].map((i) => (
                <MenuItem key={`waiver-start-${i}`} value={i}>
                  {i === 0
                    ? `Season Start`
                    : i === 18
                    ? `Season End`
          ...
          <FormControl fullWidth>
            ...
            <Select
              ...
              label="Waiver End"
              onChange={(event) =>
                handleChange("WaiversToWeek", event.target.value)
              }
            >
              {[...Array(19).keys()].map((i) => (
                <MenuItem key={`waiver-end-${i}`} value={i}>
                  {i === 0
                    ? `Season Start`
                    : i === 18
                    ? `Season End`
        ...
        >
          <FormControl fullWidth>
            <InputLabel id="waiver-process-day-select-label">
              Process Waivers Every
            </InputLabel>
            <Select
              ...
              onChange={(event) =>
                handleChange("WaiverProcessDay", +event.target.value)
              }
            >
        ...
        <FormGroup>
          <FormControlLabel
            control={
              <Checkbox
                name="unlimitedAddDrops"
                checked={unlimited}
                onChange={(event) =>
                  handleChange("UnlimitedAddDrops", event.target.checked)
                }
              />
            }
            label="Enable Unlimited Add/Drops"
          />
        </FormGroup>
        <Box
          sx={{
        ...
        >
          <FormControl fullWidth>
            <InputLabel id="unlimited-start-select-label">
              Unlimited Start
            </InputLabel>
            <Select
              ...
              onChange={(event) =>
                handleChange("UnlimitedAddDropsFromWeek", event.target.value)
              }
            >
              {[...Array(19).keys()].map((i) => (
                <MenuItem key={`unlimited-start-${i}`} value={i}>
                  {i === 0
                    ? `Season Start`
                    : i === 18
                    ? `Season End`
          ...
          <FormHelperText>to</FormHelperText>
          <FormControl fullWidth>
            <InputLabel id="unlimited-end-select-label">
              Unlimited End
            </InputLabel>
            <Select
              ...
              label="Unlimited End"
              onChange={(event) =>
                handleChange("UnlimitedAddDropsToWeek", event.target.value)
              }
            >
              {[...Array(19).keys()].map((i) => (
                <MenuItem key={`unlimited-end-${i}`} value={i}>
                  {i === 0
                    ? `Season Start`
                    : i === 18
                    ? `Season End`
        ...
        >
          <FormControl fullWidth>
            ...
            <Select
              ...
              label="Fee Start"
              onChange={(event) =>
                handleChange("AddDropFeeFromWeek", event.target.value)
              }
            >
              {[...Array(19).keys()].map((i) => (
                <MenuItem key={`fee-start-${i}`} value={i}>
                  {i === 0
                    ? `Season Start`
                    : i === 18
                    ? `Season End`
          ...
          <FormControl fullWidth>
            ...
            <Select
              ...
              label="Fee End"
              onChange={(event) =>
                handleChange("AddDropFeeToWeek", event.target.value)
              }
            >
              {[...Array(19).keys()].map((i) => (
                <MenuItem key={`fee-end-${i}`} value={i}>
                  {i === 0
                    ? `Season Start`
                    : i === 18
                    ? `Season End`
          ...
          <FormControlLabel
            control={
              <Checkbox
                ...
                checked={keeperDrop}
                onChange={(event) =>
                  handleChange("AllowDropEligibleKeeper", event.target.checked)
                }
              />
            }
