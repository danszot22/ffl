...
export default function NavItems({
  ...
  return (
    <>
      ...
      <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
        <Button color="inherit" to="/Standings">
          Standings
        </Button>
      </Typography>
      <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
        <Button color="inherit" to="/Scoring">
          Scoring
        </Button>
      </Typography>
      <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
      ...
      <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
        <MenuList title="Players">
          <MenuItem to="/PlayerList/1?availability=All&spot=All">
            Player Listing
          </MenuItem>
