...
export const setSeasonYear = (payload) => ({
  type: "SET_SEASON_YEAR",
  payload,
});
export const setLineupWeek = (payload) => ({
  type: "SET_LINEUP_WEEK",
  payload,
});
export const setLastScoredWeek = (payload) => ({
  type: "SET_LAST_SCORED_WEEK",
  payload,
});
